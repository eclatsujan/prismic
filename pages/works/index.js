                        ...
                        <div className="col-md-12">
                           
                            {
                                 works.statusCode ==403 ? (
                                    <h1>
                                Cannot Load data due to some error
                                    </h1>                                    
                                ):
                                works.map((work)=>(
                                <div className="w-showcase">
                                    ...
                                    <h3><a href={`${work.website_url}`}>{work.title}</a></h3>
                                    <p>{work.description}</p>
                                    </div>
                                    <img src={`${config.URL}${work.feature_image.url}`} className="img-fluid" alt />
                                </div> 
                                ))
                            }
